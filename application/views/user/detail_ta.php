<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="<?= base_url('user/pendataan_ta') ?>">Pendataan TA</a>
            </li>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <td align=left>
                    ...
                    <a href="<?= base_url() . 'upload/data/' . $detail->file_ta; ?>" target="_blank">
                        -Download File-
                    </a>
                </td>
            </div>
            ...
            <div class="form-group col-md-6">
                ...
                <td align=left>
                    ...
                    <a href="<?= base_url() . 'upload/data/' . $detail->luaran_ta; ?>" target="_blank">
                        -Download File-
                    </a>
                </td>
            </div>
